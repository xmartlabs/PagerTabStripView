    ...
    @MainActor var body: some View {
            ZStack {
                Text(title)
                    ...
                    .animation(.easeInOut, value: pagerSettings.transitionProgress)
                    .font(.system(size: Double.interpolate(a: 30, b: 15, progress: pagerSettings.transitionProgress.progressFor(tag: tag))))
